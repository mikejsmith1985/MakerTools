"""
Texture Stamp for FusionCam.

Procedurally generates surface texture patterns and applies them to Fusion 360
model faces using the Emboss feature. Works on both planar and curved faces.
